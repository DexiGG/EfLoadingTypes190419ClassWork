namespace EfLoadingTypes
{
    ...
    public class DataContext : DbContext
    {
        ...
        // "EfLoadingTypes.DataContext" в экземпляре LocalDb. 
        // 
        ...
        public DbSet<Book> Books { get; set; } //Для создания таблицы Книга
        public DbSet<Author> Authors { get; set; } // Для создания таблица Авторы
